                ...
                <div className="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            className="w-10 h-10 bg-purple-100 hover:bg-purple-200 rounded-full flex items-center justify-center transition-colors relative"
                        >
                    ...
                    <div className="flex justify-around">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`flex flex-col items-center py-3 px-4 transition-all duration-200 ${activeTab === tab.id
                            ...
                            >
                                ...
                                {activeTab === tab.id && (
                                    <div className="w-8 h-1 bg-purple-600 rounded-full mt-1 animate-pulse"></div>
                                )}
                            </button>
                        ))}
                    </div>
