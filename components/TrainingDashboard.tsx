                    ...
                    <div className="py-1 px-4 sm:px-6 flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-4">
                            ...
                            <button
                                ...
                                className="perfect-circle circle-md text-purple-500 border-2 border-purple-400 hover:border-purple-500 bg-purple-500/10 shadow-[0_0_16px_rgba(168,85,247,0.35)] dark:text-purple-300 flex items-center justify-center transition-colors relative"
                            >
