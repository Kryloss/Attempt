            ...
            <div className="flex items-start justify-between">
                ...
                <div className="ml-2 sm:ml-4 flex flex-col items-end flex-shrink-0">
                    <button
                        ...
                        className="w-6 h-6 sm:w-8 sm:h-8 bg-red-100 hover:bg-red-200 text-red-600 rounded-full flex items-center justify-center transition-colors opacity-0 group-hover:opacity-100"
                    >
