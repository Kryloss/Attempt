...
export default function EmailDashboard() {
    ...
    return (
        <div className="card p-6 mb-6">
            <h2 className="text-2xl font-bold text-purple-800 mb-6 font-display">Email Dashboard</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-purple-50 p-4 rounded-xl border border-purple-200">
                    <h3 className="text-lg font-semibold text-purple-800">Total Emails</h3>
                    <p className="text-3xl font-bold text-purple-600">{emailData.totalEmails}</p>
                </div>
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold text-purple-800 mb-3">Recent Emails</h3>
                    ...
                    <table className="min-w-full bg-purple-50 rounded-xl">
                        <thead>
                            <tr className="border-b border-purple-200">
                                ...
                                <th className="px-4 py-3 text-left text-sm font-medium text-purple-700">Sent At</th>
                            </tr>
                        </thead>
                        <tbody>
                            {emailData.emails.slice(0, 10).map((email, index) => (
                                <tr key={email._id || index} className="border-b border-purple-100">
                                    <td className="px-4 py-3 text-sm text-purple-900">{email.email}</td>
